...
export const CARDS = [
  ...
  },
  {
    ...
    scene: {
      ...
      // 템플릿 매칭으로 찾은 값이다. 받은 누끼에는 **떠다니는 잎 조각이 16:9 캔버스
      // 전체에 흩어져 있어서** 그것까지 넣으면 경계상자가 과하게 넓어진다(1326x919).
      // 본체 덩어리 하나만 잘라(1056x919) 카드 그림과 맞추면 배율 0.705 에서 맞는다.
      // 흩어진 잎은 아래 leaves 파티클이 대신한다.
      fit: { x: 10.11, y: 17.60, w: 82.67, h: 57.60 },
      motes: 46,
